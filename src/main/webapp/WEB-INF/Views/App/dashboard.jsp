...
<div class="content">
  <h2>Recent orders</h2>
  <p>Here are your recent orders. Click on their OrderIDs to show more details.</p><br>
  <span style="color:red;">${ordIderrMsg}</span>
</div>

<div class="tg-wrap"><table id="tg-R6anf" class="tg">
  <tr>
    <th class="tg-0lax">OrderID</th>
    <th class="tg-0lax">OrderTime</th>
    <th class="tg-0lax">PlannedTime</th>
    <th class="tg-0lax">EstimatedTime</th>
    <th class="tg-0lax">Location</th>
    <th class="tg-0lax">Status</th>
  </tr>
  <c:forEach items="${custOrdLatest}" var="order">
	  <tr>
	    <td class="tg-0lax"><a href="/app/orderdet/${order.orderID}">${order.orderID}</a></td>
	    <td class="tg-0lax"><javatime:format value="${order.orderTime}" style="SS"/></td>
	    <td class="tg-0lax"><javatime:format value="${order.plannedTime}" style="SS"/></td>
	    <td class="tg-0lax"><javatime:format value="${order.estimatedTime}" style="SS"/></td>
	    <td class="tg-0lax">${order.location}</td>
	    <td class="tg-0lax"><c:choose><c:when test='${order.status == 0}'>On time</c:when>
	    					<c:otherwise>Delayed</c:otherwise></c:choose></td>
	  </tr>
  </c:forEach>
</table></div>
...
<div class="content">
  ...
  <p>Here are your recent messages.</p>
  <span style="color:red;">${msgIderrMsg}</span>
</div>
...
<div class="tg-wrap"><table id="tg-R6anf" class="tg">
  ...
  <c:forEach items="${custMsgLatest}" var="msg">
	  <tr>
