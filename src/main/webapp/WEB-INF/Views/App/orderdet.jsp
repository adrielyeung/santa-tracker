...
<html lang="en">
<head>
<title>Order #${curOrderID} Details</title>
<meta charset="utf-8">
...
<div class="content">
  <h2>Order #${curOrderID} details</h2>
  <p>Please find below the most updated details.</p>
</div>

<div class="tg-wrap"><table id="tg-R6anf" class="tg">
  <tr>
	    <th class="tg-0lax">ProductID</th>
	    <th class="tg-0lax">ProductName</th>
	    <th class="tg-0lax">Specifications</th>
	    <th class="tg-0lax">UnitPrice</th>
	    <th class="tg-0lax">Quantity</th>
  </tr>
  <c:forEach items="${ordDet}" var="orddet">
	  <tr>
