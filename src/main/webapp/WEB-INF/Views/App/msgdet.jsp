...
<div class="content">
  <h2>Message #${curMsgID} details</h2>
  <p>Please find below the most updated details.</p>
</div>

<div class="tg-wrap"><table id="tg-R6anf" class="tg">
  <tr>
    <th class="tg-0lax"><b>Title</b></th>
  </tr>
  <tr>
  	<td class="tg-0lax">${msgTitle}</td>
  </tr>
  <tr>
  	<th class="tg-0lax"><b>Message</b></td> 
  </tr>
  <tr>
  	<td class="tg-0lax">${msgBody}</td>
  </tr>
  <tr>
  	<th class="tg-0lax"><b>From</b></td>
  </tr>
  <tr>
  	<td class="tg-0lax"><c:choose><c:when test='${fromCustomer == 1}'>You</c:when>
	    					<c:otherwise>Us</c:otherwise></c:choose></td>
  </tr>
  <tr>
  	<th class="tg-0lax"><b>SentTime</b></td>
  </tr>
  <tr>
  	<td class="tg-0lax"><javatime:format value="${sentTime}" style="SS"/></td>
  </tr>
</table></div>
