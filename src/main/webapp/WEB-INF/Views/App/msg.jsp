...
<div class="content">
  <h2>Messages of order #${order.orderID}</h2>
  <p>Here are all your messages related to this order #${order.orderID}. Click on their Message IDs to show more details.</p><br>
  <span style="color:red;">${msgErrMsg}</span> <br>
...
<div class="tg-wrap"><table id="tg-R6anf" class="tg">
  <thead>
	  <tr>
	    ...
	    <th class="tg-0lax">Message Body</th>
	  </tr>
  </thead>
  <tbody>
	  <c:forEach items="${order.orderMsgs}" var="msg">
		  <tr>
